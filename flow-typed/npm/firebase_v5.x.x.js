...
declare class $npm$firebase$auth$Auth {
  ...
  onIdTokenChanged(
    nextOrObserver:
      | Object
      | ((user?: $npm$firebase$auth$User) => void | Promise<void>),
    error?: (error: $npm$firebase$auth$Error) => void,
    completed?: () => void
  ): () => void;
  sendPasswordResetEmail(email: string): Promise<void>;
  setPersistence(
    persistence: $npm$firebase$auth$Auth$Persistence$Enum
  ): Promise<void>;
...
declare class $npm$firebase$auth$User extends $npm$firebase$auth$UserInfo {
  ...
  sendEmailVerification(
    actionCodeSettings?: $npm$firebase$actionCode$settings
  ): Promise<void>;
  toJSON(): Object;
...
declare class $npm$firebase$firestore$Firestore {
  ...
  enablePersistence(
    settings?: $npm$firebase$firestore$PersistenceSettings
  ): Promise<void>;
  runTransaction(
    updateFunction: (
...
declare class $npm$firebase$firestore$DocumentReference {
  ...
  set(
    data: { +[string]: mixed, ... },
    options?: {| merge?: boolean, mergeFields?: string[] |} | null
  ): Promise<void>;
...
declare class $npm$firebase$firestore$GeoPoint {
  constructor(
    latitude: number,
    longitude: number
  ): $npm$firebase$firestore$GeoPoint;
  latitude: number;
  longitude: number;
...
declare class $npm$firebase$firestore$QuerySnapshot {
  ...
  size: number;
  forEach(
    (snapshot: $npm$firebase$firestore$DocumentSnapshot, thisArg?: any) => void
  ): void;
